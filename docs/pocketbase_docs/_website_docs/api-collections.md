...
Web APIs reference - API Collections - Docs - PocketBase
...
**GET** /api/collections Requires `Authorization:TOKEN` Query parameters
...
**GET** /api/collections/`collectionIdOrName` Requires `Authorization:TOKEN` Path parameters
...
**POST** /api/collections Requires `Authorization:TOKEN` Body Parameters
...
**PATCH** /api/collections/`collectionIdOrName` Requires `Authorization:TOKEN` Path parameters
...
**DELETE** /api/collections/`collectionIdOrName` Requires `Authorization:TOKEN` Path parameters

| Param | Type | Description |
| --- | --- | --- |
| collectionIdOrName | String | ID or name of the collection to view. |

Responses 204 400 401 403 404  `null` `{
"status": 400,
...
**DELETE** /api/collections/`collectionIdOrName`/truncate Requires `Authorization:TOKEN` Path parameters
...
**PUT** /api/collections/import Requires `Authorization:TOKEN` Body Parameters
...
**GET** /api/collections/meta/scaffolds Requires `Authorization:TOKEN` Responses 200 401 403 404  `{
"auth": {
"id": "",
"listRule": null,
"viewRule": null,
...
---
  ...
  [Prev: API Files](api-files.md) [Next: API Settings](api-settings.md)  [FAQ](/faq) [Discussions](https://github.com/pocketbase/pocketbase/discussions) [Documentation](/docs) [JavaScript SDK](https://github.com/pocketbase/js-sdk) [Dart SDK](https://github.com/pocketbase/dart-sdk) Pocket**Base**   © 2023-2025 Pocket**Base** The Gopher artwork is from
