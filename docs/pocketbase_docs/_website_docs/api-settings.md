...
Web APIs reference - API Settings - Docs - PocketBase
...
**GET** /api/settings Requires `Authorization:TOKEN` Query parameters
...
**PATCH** /api/settings Requires `Authorization:TOKEN` Body Parameters
...
"message": "The authorized record is not allowed to perform this action.",
"data": {}
}`   **[Test S3 storage connection](#test-s3-storage-connection)**  
...
**POST** /api/settings/test/s3 Requires `Authorization:TOKEN` Body Parameters
...
Body parameters could be sent as *JSON* or
*multipart/form-data*. Responses 204 400 401  `null` `{
"status": 400,
...
...
await pb.collection("_superusers").authWithPassword('test@example.com', '1234567890');
await pb.settings.testEmail("test@example.com", "verification");` `import 'package:pocketbase/pocketbase.dart';
final pb = PocketBase('http://127.0.0.1:8090');
...
await pb.collection("_superusers").authWithPassword('test@example.com', '1234567890');
...
**POST** /api/settings/test/email Requires `Authorization:TOKEN` Body Parameters
...
"message": "The request requires valid record authorization token.",
"data": {}
}`   **[Generate Apple client secret](#generate-apple-client-secret)**  
...
**POST** /api/settings/apple/generate-client-secret Requires `Authorization:TOKEN` Body Parameters
...
Body parameters could be sent as *JSON* or
*multipart/form-data*. Responses 200 400 401  `{
"secret": "..."
}` `{
"status": 400,
...
---
  ...
  [Prev: API Collections](api-collections.md) [Next: API Logs](api-logs.md)  [FAQ](/faq) [Discussions](https://github.com/pocketbase/pocketbase/discussions) [Documentation](/docs) [JavaScript SDK](https://github.com/pocketbase/js-sdk) [Dart SDK](https://github.com/pocketbase/dart-sdk) Pocket**Base**   © 2023-2025 Pocket**Base** The Gopher artwork is from
