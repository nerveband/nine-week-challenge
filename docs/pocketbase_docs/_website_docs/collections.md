...
[Files upload and handling](files-handling/.md) guide.
...
---
  ...
  [Prev: How to use PocketBase](how-to-use.md) [Next: API rules and filters](api-rules-and-filters.md)  [FAQ](/faq) [Discussions](https://github.com/pocketbase/pocketbase/discussions) [Documentation](/docs) [JavaScript SDK](https://github.com/pocketbase/js-sdk) [Dart SDK](https://github.com/pocketbase/dart-sdk) Pocket**Base**   © 2023-2025 Pocket**Base** The Gopher artwork is from
