...
Introduction - How to use PocketBase - Docs - PocketBase
...
[collection API rules](api-rules-and-filters/.md)
.
...
[extend PocketBase with Go or JavaScript](use-as-framework/.md)
.

For interacting with the
[Web APIs](api-records/.md)
 ...
 **[Web apps recommendation](#web-apps-recommendation)**  
...
* [Use PocketBase as Go/JS framework](use-as-framework.md) to create new routes or
  intercept existing.
...
[JS SSR integration section](https://github.com/pocketbase/js-sdk#ssr-integration).
  ...
  **[Why not htmx, Hotwire/Turbo, Unpoly, etc.](#why-not-htmx-hotwireturbo-unpoly-etc-)**  
...
cookies (*and eventually taking care also for CORS and CSRF*) or custom authentication
...
mentioned earlier or use a different backend solution that might fit better with your use case.
  ...
  **[Mobile apps auth persistence](#mobile-apps-auth-persistence)**  
...
JavaScript Dart  `// Node.js and React Native doesn't have native EventSource implementation
...
...
await pb.collection('users').authWithPassword('test@example.com', '1234567890');
print(pb.authStore.record);`   **[React Native file upload on Android and iOS](#react-native-file-upload-on-android-and-ios)**  
...
---
  ...
  [Prev: Introduction](/docs) [Next: Collections](collections.md)  [FAQ](/faq) [Discussions](https://github.com/pocketbase/pocketbase/discussions) [Documentation](/docs) [JavaScript SDK](https://github.com/pocketbase/js-sdk) [Dart SDK](https://github.com/pocketbase/dart-sdk) Pocket**Base**   © 2023-2025 Pocket**Base** The Gopher artwork is from
