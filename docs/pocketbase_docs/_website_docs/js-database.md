...
you could also check [Collection operations](js-collections.md)
and
[Record operations](js-records.md) sections.
...
---
  ...
  [Prev: Routing](js-routing.md) [Next: Record operations](js-records.md)  [FAQ](/faq) [Discussions](https://github.com/pocketbase/pocketbase/discussions) [Documentation](/docs) [JavaScript SDK](https://github.com/pocketbase/js-sdk) [Dart SDK](https://github.com/pocketbase/dart-sdk) Pocket**Base**   © 2023-2025 Pocket**Base** The Gopher artwork is from
