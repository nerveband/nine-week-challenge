...
e.message.subject = "new subject"
e.next()
})` **[onMailerRecordPasswordResetSend](#onmailerrecordpasswordresetsend)**  
...
e.next()
}, "posts")` **[onRecordValidate](#onrecordvalidate)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordCreateExecute](#onrecordcreateexecute)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordAfterCreateSuccess](#onrecordaftercreatesuccess)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordAfterCreateError](#onrecordaftercreateerror)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordUpdateExecute](#onrecordupdateexecute)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordAfterUpdateSuccess](#onrecordafterupdatesuccess)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordAfterUpdateError](#onrecordafterupdateerror)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordDeleteExecute](#onrecorddeleteexecute)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordAfterDeleteSuccess](#onrecordafterdeletesuccess)**  
...
// e.record
e.next()
}, "users", "articles")` **[onRecordAfterDeleteError](#onrecordafterdeleteerror)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionCreateExecute](#oncollectioncreateexecute)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionAfterCreateSuccess](#oncollectionaftercreatesuccess)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionAfterCreateError](#oncollectionaftercreateerror)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionUpdateExecute](#oncollectionupdateexecute)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionAfterUpdateSuccess](#oncollectionafterupdatesuccess)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionAfterUpdateError](#oncollectionafterupdateerror)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionDeleteExecute](#oncollectiondeleteexecute)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionAfterDeleteSuccess](#oncollectionafterdeletesuccess)**  
...
// e.collection
e.next()
}, "users", "articles")` **[onCollectionAfterDeleteError](#oncollectionafterdeleteerror)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "articles")` **[onRecordViewRequest](#onrecordviewrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "articles")` **[onRecordCreateRequest](#onrecordcreaterequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "articles")` **[onRecordUpdateRequest](#onrecordupdaterequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "articles")` **[onRecordDeleteRequest](#onrecorddeleterequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordAuthRefreshRequest](#onrecordauthrefreshrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordAuthWithPasswordRequest](#onrecordauthwithpasswordrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordAuthWithOAuth2Request](#onrecordauthwithoauth2request)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordRequestPasswordResetRequest](#onrecordrequestpasswordresetrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordConfirmPasswordResetRequest](#onrecordconfirmpasswordresetrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordRequestVerificationRequest](#onrecordrequestverificationrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordConfirmVerificationRequest](#onrecordconfirmverificationrequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordRequestEmailChangeRequest](#onrecordrequestemailchangerequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordConfirmEmailChangeRequest](#onrecordconfirmemailchangerequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordRequestOTPRequest](#onrecordrequestotprequest)**  
...
// and all RequestEvent fields...
e.next()
}, "users", "managers")` **[onRecordAuthWithOTPRequest](#onrecordauthwithotprequest)**  
...
[`onRecord*`](#record-model-hooks)
and
[`onCollection*`](#collection-model-hooks)
proxy hooks above.
...
// e.model
e.next()
}, "users", "articles")` **[onModelCreateExecute](#onmodelcreateexecute)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelAfterCreateSuccess](#onmodelaftercreatesuccess)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelAfterCreateError](#onmodelaftercreateerror)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelUpdateExecute](#onmodelupdateexecute)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelAfterUpdateSuccess](#onmodelafterupdatesuccess)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelAfterUpdateError](#onmodelafterupdateerror)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelDeleteExecute](#onmodeldeleteexecute)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelAfterDeleteSuccess](#onmodelafterdeletesuccess)**  
...
// e.model
e.next()
}, "users", "articles")` **[onModelAfterDeleteError](#onmodelafterdeleteerror)**  
...
---
  ...
  [Prev: Overview](js-overview.md) [Next: Routing](js-routing.md)  [FAQ](/faq) [Discussions](https://github.com/pocketbase/pocketbase/discussions) [Documentation](/docs) [JavaScript SDK](https://github.com/pocketbase/js-sdk) [Dart SDK](https://github.com/pocketbase/dart-sdk) Pocket**Base**   © 2023-2025 Pocket**Base** The Gopher artwork is from
